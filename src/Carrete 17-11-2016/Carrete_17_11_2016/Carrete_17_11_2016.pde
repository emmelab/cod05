...
void keyPressed() {
  ...
  if (conectadoConSistema) {
    ...
    if (key == 'q' || key == 'Q') {
      //esto esta mal... deberias teneruna coleccion
      // de las opciones desde le inicio igual que el de 
      //los modificiadores y esperar una confirmacion de 
      //si se a iomplementado o no
      //consola.mandarMensaje("/pedir/opciones");
