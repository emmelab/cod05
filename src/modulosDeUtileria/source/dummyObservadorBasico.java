...
public class dummyObservadorBasico extends PApplet {
...
public void draw(){
  ...
  pushMatrix();
  translate(textWidth("WebCAm"), 0);
  textSize(24);
  text("puerto = "+puertoObs,0,0);
  popMatrix();
  translate(0,28);
...
class ConfiguracionCOD05 {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "dummyObservadorBasico" };
    if (passedArgs != null) {
